import { DEFAULT_SURFACE_APPEARANCE_PROPS, DEFAULT_DIMENSION_PROPS, DEFAULT_INTERACTIVE_PROPS, DEFAULT_LAYOUT_PROPS, DEFAULT_SPACING_PROPS } from "@workspace/ui/defaults";
...
export const DEFAULT_PROPS: Partial<BoxProps> = {
  ...
  ...DEFAULT_SURFACE_APPEARANCE_PROPS,
