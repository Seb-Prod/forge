...
<p align="center">
  Composants bouton et link scopé via attributs <code>data-*</code> — aucune classe CSS requise.
</p>
...
Tous les styles sont scopés à `[data-role="button"]`. Les attributs `data-tone`, `data-appearance`, `data-animation` et `data-size` sont indépendants et combinables librement.
...
| Valeur    | Description                |
| --------- | -------------------------- |
| `"button"` | Active les styles du button |
...
| `"ghost"` | Discret, sans fond ni bordure  |
| `"link"` | Apparence de lien texte, souvent souligné  |
