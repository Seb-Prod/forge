...
export const ANIMATIONS = {
  ...
  splitH: { value: "split-h", label: "Split Horizontal", description: "Ouverture horizontale" },
  splitV: { value: "split-v", label: "Split Vertical",   description: "Ouverture verticale"  },
